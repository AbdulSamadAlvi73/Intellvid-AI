  ...
  return (
    ...
    >
      <div className="md:max-w-[75vw] mx-auto xs:py-[5vw] md:pb-[2vw] px-5 flex flex-col">
        <div className="w-full h-full grid md:gap-4 lg:gap-[6vw] xs:pb-[5vw] md:pb-[7vw] xs:grid-cols-1 md:grid-cols-2">
          ...
          <div className="py-5">
            <h2 className="lg:text-[3vw] md:text-[3.8vw] xs:text-[4.5vw] tracking-wide xs:leading-[6.8vw] lg:leading-[3.5vw] md:leading-[4vw] font-semibold">
              Create Content in Minutes Not Hour
            </h2>
            <p className="font-semibold tracking-wide xs:text-[2.5vw] lg:text-[1.2vw] lg:mt-[0.5vw] md:mt-[1vw] sm:mt-[1.5vw] xs:mt-[2vw]">
              In a few seconds.our A.I. will generate amazing result that ou can
              copy, paste & Publish , write creativety and clearl in 25+ lanuag
              s
            </p>
            <div className="flex flex-col lg:gap-[1.4vw] xs:gap-[2.5vw] lg:my-[2.5vw] md:my-[3.5vw] sm:my-[4.3vw] xs:my-[5.5vw]">
              <div className="flex items-center gap-4">
                ...
                <p className="xs:text-[2.5vw] lg:text-[1.2vw] md:text-[1.7vw] tracking-wide">
                  Easily Write And Test More copy variations
                </p>
              </div>
              <div className="flex items-center gap-4">
                <div className="lg:p-[0.5vw] md:p-[1vw] sm:p-[1.5vw]  rounded-full bg-theme-purple/30">
                ...
                <p className="xs:text-[2.5vw] lg:text-[1.2vw] md:text-[1.7vw] tracking-wide">
                  Generate Content That are keyword-rich and plagiaris -free.
                </p>
              </div>
              <div className="flex items-center gap-4">
                <div className="lg:p-[0.5vw] md:p-[1vw] sm:p-[1.5vw]  rounded-full bg-theme-purple/30">
                ...
                <p className="xs:text-[2.5vw] lg:text-[1.2vw] md:text-[1.7vw] tracking-wide">
                  No Matter Your Native tongue, write creatively
                </p>
              </div>
            </div>
        ...
        <div className="w-full h-full xs:flex flex-col-reverse md:grid md:gap-4 lg:gap-[6vw] xs:pb-16 md:pb-32 xs:grid-cols-1 md:grid-cols-2">
          <div className="py-5">
            <h2 className="lg:text-[3vw] md:text-[3.8vw] xs:text-[4.5vw] tracking-wide xs:leading-[6.8vw] lg:leading-[3.5vw] md:leading-[4vw] font-semibold">
              Create Content in Minutes Not Hour
            </h2>
