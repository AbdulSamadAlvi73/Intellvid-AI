  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (response.status == 200) {
        ...
        navigate("/dashboard/auth/resetpassword");
      }
    } catch (error) {
...
<h1 className="text-xl">loading....</h1>
                ...
                <button onClick={handleSubmit} className="lg:py-[1vw] xs:py-[2vw] lg:text-[1.2vw] md:text-[2.2vw] sm:text-[3.3vw] xs:text-[3.2vw] videoGradient rounded-full mt-7">
                  Send OTP
                </button>
              )}
            </div>
