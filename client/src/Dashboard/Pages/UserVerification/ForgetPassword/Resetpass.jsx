...
/>
   ...
   <label
            ...
            {loading ? (
                ...
                <div className="lg:w-10 lg:h-10 md:w-10 md:h-10 border-4 border-gray-300 border-t-blue-500 rounded-full animate-spin"></div>
              </div>
              ) : (
                <button onClick={SubmitHandler} className="lg:py-[1vw] xs:py-[2vw] lg:text-[1.2vw] md:text-[2.2vw] sm:text-[3.3vw] xs:text-[3.2vw] videoGradient rounded-full mt-7">
                  Send OTP
                </button>
              )}
            </div>
