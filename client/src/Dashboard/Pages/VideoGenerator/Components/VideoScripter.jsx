    ...
    {console.log(ageSelect)
      ...
      {isVideoConentShow ? (
        ...
        <div className="lg:w-[50vw] min-h-screen pt-[3vw] md:w-[93vw] text-white sm:w-[90vw] xs:w-[100vw] xs:ml-auto lg:mx-auto relative">
          ...
          >
               {loading && <div className="flex items-center justify-center"><p className="md:text-[12px] lg:text-[13px] sm:text-[8px] xs:text-[7px]">Generating....</p>
      ...
      <div className="w-4 h-4 border-3 border-gray-300 border-t-blue-500 rounded-full animate-spin"></div>
          ...
          readOnly
            ...
            <div className="flex justify-between w-full items-center">
              ...
              {loading? <div className="bg-gray-400 px-5 py-2 rounded-lg flex items-center justify-center videoGradient ">
